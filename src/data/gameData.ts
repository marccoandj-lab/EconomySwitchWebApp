...
export const financeListings: ListingChallenge[] = [
  {
    ...
    answers: ["Rental income", "Stock dividends", "Copyright royalties", "Savings interest", "Affiliate marketing", "Business profits", "REIT distributions", "Peer-to-peer lending", "Vending machines", "Digital products"],
