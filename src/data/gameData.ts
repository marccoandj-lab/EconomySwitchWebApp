...
export const financeQuizzes: QuizQuestion[] = [
  {
    question: "What does a personal budget represent?",
    options: [
  ...
  {
    question: "What does it mean to make a profit?",
    options: [
  ...
  {
    question: "What does an investment represent?",
    options: [
  ...
  {
    question: "What is a company's income (revenue)?",
    options: [
  ...
  {
    question: "What are business costs (expenses)?",
    options: [
  ...
  {
    question: "What does bankruptcy mean?",
    options: [
      "A) Profit growth.",
  ...
  {
    question: "What does an individual's credit rating represent?",
    options: [
  ...
  {
    question: "What is the Effective Interest Rate (EIR)?",
    options: [
  ...
  {
    question: "What does loan refinancing mean?",
    options: [
  ...
  {
    question: "What does a diversified investment portfolio represent?",
    options: [
  ...
  {
    question: "How does an increase in interest rates affect borrowing?",
    options: [
  ...
  {
    question: "What does a financial reserve (emergency fund) represent?",
    options: [
  ...
  {
    question: "What does nominal interest mean?",
    options: [
  ...
  {
    question: "What are external costs (externalities)?",
    options: [
  ...
  {
    question: "What is profit tax (corporate income tax)?",
    options: [
  ...
  {
    question: "What does an annuity represent?",
    options: [
  ...
  {
    question: "What does it mean to be over-indebted?",
    options: [
  ...
  {
    question: "What is the payback period of an investment?",
    options: [
  ...
  {
    question: "What does inflation-adjusted return mean?",
    options: [
  ...
  {
    question: "What does capital turnover represent?",
    options: [
  ...
  {
    question: "What does the financial stability of a household mean?",
    options: [
  ...
  {
    question: "What is a company's liquidity?",
    options: [
  ...
  {
    question: "What is the minimum share capital for a limited liability company (LLC) in Serbia?",
    options: [
      "A) 500 dinars",
      "B) 1000 dinars",
      "C) 2000 dinars",
  ...
  {
    question: "What is the Net Present Value (NPV) of an investment?",
    options: [
  ...
  {
    question: "What does it mean for an investment to be highly volatile?",
    options: [
  ...
  {
    question: "How does financial leverage affect the return on investment?",
    options: [
  ...
  {
    question: "What does the Debt-to-Equity ratio represent?",
    options: [
  ...
  {
    question: "What does it mean to be a lump-sum taxed entrepreneur?",
    options: [
  ...
  {
    question: "What does the liquidation value of an asset mean?",
    options: [
  ...
  {
    question: "How does an increase in the central bank's benchmark interest rate affect the credit market?",
    options: [
  ...
  {
    question: "When does a company in Serbia become a VAT payer?",
    options: [
  ...
  {
    question: "What is the main difference between an entrepreneur and an LLC?",
    options: [
  ...
  {
    question: "What does hedging mean in finance?",
    options: [
  ...
  {
    question: "What does operating leverage represent?",
    options: [
  ...
  {
    question: "How does high inflation affect fixed-rate debt?",
    options: [
  ...
  {
    question: "What does capital gain represent?",
    options: [
  ...
  {
    question: "What does it mean for an investment to be liquid but high-risk?",
    options: [
  ...
  {
    question: "What do compulsory social security contributions represent?",
    options: [
  ...
  {
    question: "If the inflation rate is 8% and the interest on savings is 5%, what is the real interest rate?",
    options: [
  ...
  {
    question: "Which institution is responsible for registering a company in Serbia?",
    options: [
  ...
  {
    question: "How does the linear economic model affect natural resources?",
    options: [
...
export const sustainabilityQuizzes: QuizQuestion[] = [
  {
    question: "What does renewable energy source mean?",
    options: [
  ...
  {
    question: "What is paper recycling?",
    options: [
  ...
  {
    question: "What is local food production?",
    options: [
  ...
  {
    question: "What does reducing plastic in everyday life mean?",
    options: [
  ...
  {
    question: "What is the sharing economy?",
    options: [
  ...
  {
    question: "What does \"reduce waste\" mean?",
    options: [
  ...
  {
    question: "What is an ecological product certificate?",
    options: [
  ...
  {
    question: "What does regenerative agriculture mean?",
    options: [
  ...
  {
    question: "What does \"green purchasing\" mean?",
    options: [
  ...
  {
    question: "What does a circular business model mean?",
    options: [
  ...
  {
    question: "What is a product's carbon footprint?",
    options: [
  ...
  {
    question: "What is ESG reporting?",
    options: [
  ...
  {
    question: "What is energy efficiency in buildings?",
    options: [
  ...
  {
    question: "What is the \"cradle-to-cradle\" principle?",
    options: [
  ...
  {
    question: "What does \"sustainable consumption\" mean?",
    options: [
  ...
  {
    question: "What is a regenerative economy?",
    options: [
  ...
  {
    question: "What does the \"zero waste\" philosophy mean?",
    options: [
  ...
  {
    question: "What is ecological product design?",
    options: [
  ...
  {
    question: "What does \"sustainable supply chains\" mean?",
    options: [
  ...
  {
    question: "What is CO2 emissions?",
    options: [
  ...
  {
    question: "What does \"sustainable fashion\" mean?",
    options: [
  ...
  {
    question: "Why is extending the lifespan of products given priority in the circular economy?",
    options: [
  ...
  {
    question: "What does \"sustainable diet\" mean?",
    options: [
  ...
  {
    question: "Which is an example of the circular economy?",
    options: [
  ...
  {
    question: "What does \"sustainable water consumption\" mean?",
    options: [
  ...
  {
    question: "What is eco-innovation?",
    options: [
  ...
  {
    question: "What does \"minimal waste in production\" mean?",
    options: [
  ...
  {
    question: "What does the ESG criterion represent?",
    options: [
      "A) Bank interest.",
      "B) State tax.",
  ...
  {
    question: "What is a Product Life Cycle Assessment (LCA)?",
    options: [
  ...
  {
    question: "What does a company's carbon neutrality represent?",
    options: [
  ...
  {
    question: "What does \"closed production cycle\" mean?",
    options: [
  ...
  {
    question: "What is regenerative agriculture in practice?",
    options: [
  ...
  {
    question: "What is eco-efficiency in industry?",
    options: [
  ...
  {
    question: "What does \"sustainable water resource management\" mean?",
    options: [
  ...
  {
    question: "What is green logistics?",
    options: [
  ...
  {
    question: "What does \"product life cycle extension\" mean?",
    options: [
  ...
  {
    question: "The \"polluter pays\" principle implies that:",
    options: [
  ...
  {
    question: "What does \"green building design\" mean?",
    options: [
  ...
  {
    question: "What does a forest ecological certificate represent?",
    options: [
  ...
  {
    question: "What does \"sustainable aquaculture\" mean?",
    options: [
  ...
  {
    question: "What is green technology (Green Tech)?",
    options: [
  ...
  {
    question: "What does \"socially and environmentally responsible investment\" mean?",
    options: [
  ...
  {
    question: "Which situation is the best example of internalizing a negative externality?",
    options: [
  ...
  {
    question: "What does \"resource loop\" mean in the circular economy?",
    options: [
...
export const incomeEvents: IncomeEvent[] = [
  ...
  { title: "Freelance Gig", description: "You completed a project for a client!", amount: 35000, icon: "💻" },
  { title: "Dividends", description: "Your stocks paid out a dividend!", amount: 45000, icon: "📈" },
  { title: "Bonus", description: "A nice performance bonus!", amount: 85000, icon: "🎁" },
  { title: "Rent Income", description: "Income from your property!", amount: 40000, icon: "🏠" },
  { title: "Asset Sale", description: "You sold items at a profit!", amount: 90000, icon: "🚗" },
  { title: "Savings Interest", description: "Interest on your savings account!", amount: 15000, icon: "🏦" },
  { title: "Tax Refund", description: "Tax office refund!", amount: 30000, icon: "📋" },
  { title: "Investment Gain", description: "Profit from small stocks!", amount: 75000, icon: "💰" },
  { title: "Online Income", description: "Digital business earnings!", amount: 55000, icon: "🌐" },
];

// Expenses: Fixed range [15k, 90k]
export const expenseEvents: ExpenseEvent[] = [
  { title: "Car Repair", description: "Vehicle maintenance cost.", amount: 45000, icon: "🔧" },
  { title: "Medical Bill", description: "Unexpected medical cost.", amount: 30000, icon: "🏥" },
  { title: "Legal Fees", description: "Cost of legal advice.", amount: 65000, icon: "⚖️" },
  { title: "Tax Audit", description: "Small tax adjustment.", amount: 90000, icon: "📋" },
  { title: "Home Repair", description: "Emergency structural repairs.", amount: 75000, icon: "🏠" },
  { title: "Tech Upgrade", description: "New equipment cost.", amount: 50000, icon: "💻" },
  { title: "Vacation", description: "Holiday travel expenses.", amount: 55000, icon: "✈️" },
  { title: "Shopping", description: "Essential and non-essential shopping.", amount: 15000, icon: "🛍️" },
];
